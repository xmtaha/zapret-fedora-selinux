...
if [ "${EUID}" -ne 0 ]; then
  ...
  echo -e "  ${green}curl ${white}-${yellow}fsSL ${cyan}https://raw.githubusercontent.com/xmtaha/zapret-fedora-selinux/refs/heads/main/src/install.sh ${gray}| ${green}sudo ${cyan}bash${reset}"
